...
if(temperature >= 80 && rain){
  ...
  console.log('You should wear pants and a t-shirt.')
} else if (temperature < 60 && !rain) {
  console.log('You should wear pants and a long-sleeve shirt.')
}
...
// while z is greater than zero
// countdown from the value of z to 1
// decrement the value of z by 1
